...
Director.pre_load([
    ...
    "cannon_left", "cannon_right", "cannon_by_disable", "cannon_able", "cannon_disable",
    "cannon_down", "cannon_down_left", "cannon_down_right",
    "cannon_up", "cannon_up_left", "cannon_up_right",
    "flame_left", "flame_right", "flame_by_disable", "flame_able", "flame_disable",
    ...
    "bullet_a", "bullet_b", "bullet_c",
    "explode1", "explode2", "shockwave",
